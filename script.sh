...
echo -e "\033[0;95m Colentando informações de rede... \033[0m"
...
cat -r /var/log/syslog $COLLECTED_DIR/syslog.log
cat -r /var/log/auth.log $COLLECTED_DIR/auth.log
cat -r /var/log/dmesg $COLLLECTED_DIR/dmesg.log
